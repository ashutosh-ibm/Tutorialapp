                                        ...
                                        string(credentialsId: openshift_applier_url, variable: 'OPENSHIFT_APPLIER_URL')])
                           {
                                ...
                                stage ('Ansible Play') {
                                        retry(3) {
                                         ...
                                         try {
                                        sh 'oc delete project marketingtemplateapp-build'
                                    } catch (Exception e) {
                                        echo 'project does not exist'
                                    }
                                    try {
                                        sh 'oc delete project marketingtemplateapp-dev'
                                    } catch (Exception e) {
                                        echo 'project does not exist'
                                    }
                                    try {
                                        sh 'oc delete project marketingtemplateapp-stage'
                                    } catch (Exception e) {
                                        echo 'project does not exist'
                                    }
                                    try {
                                        sh 'oc delete project marketingtemplateapp-prod'
                                    } catch (Exception e) {
                                        echo 'project does not exist'
                                    }
                                        sh 'sleep 60'
